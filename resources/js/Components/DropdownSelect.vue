...
<template>
    <div ref="dropdownContainer">
        <label class="block font-medium text-sm text-green-600" :for="id">{{ label }}</label>
        <div class="relative">
            <input type="text"
                class="mt-1 w-full border-green-200 focus:border-green-200 focus:ring-green-600 rounded shadow" :id="id"
            ...
            <div v-if="showDropdown"
                class="absolute z-10 bg-white border border-green-600 rounded mt-1 w-full max-h-20 overflow-auto">
                <ul>
