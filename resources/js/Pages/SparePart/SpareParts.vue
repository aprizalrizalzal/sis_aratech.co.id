          ...
          <Dropdown align="left" width="48">
            <template #trigger>
              <span class="inline-flex rounded">
                <button type="button"
                  class="inline-flex items-center py-4 border border-transparent text-lg leading-4 font-bold rounded text-green-700 bg-white hover:text-green-900 focus:outline-none transition ease-in-out duration-150">
                  Spare&nbsp;Parts&nbsp;
