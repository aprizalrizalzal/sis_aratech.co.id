...
<template>
    ...
    <div class="flex flex-col items-center pt-2">
        <SecondaryButton v-if="itemsPerPage === itemsPerPage" @click="showAllProduct" class="w-full justify-center">Show
            All
            &nbsp;
        ...
        <SecondaryButton v-if="itemsPerPage !== itemsPerPage" @click="hideSomeProduct" class="w-full justify-center">
            Hiding some &nbsp;
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
