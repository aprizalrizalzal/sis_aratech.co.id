...
<template>
                    ...
                    <div v-if="canLogin" class="flex items-center font-medium font-bold">
                        <div v-if="$page.props.auth.user" class="flex items-center gap-2">
                            <Link :href="route('show.dashboard')"
                                class="rounded px-3 py-2 text-green-800 ring-1 ring-transparent transition hover:text-green-600 focus:outline-none focus-visible:ring-green-600">
                            Dashboard
                            </Link>
                        </div>
                        <template v-else>
    ...
    <div class="text-green-800/50 bg-gray-50">
